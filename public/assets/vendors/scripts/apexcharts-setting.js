...
var options = {
	...
	fill: {
		...
		gradient: {
			shade: 'dark',
			gradientFromColors: [ '#AB80E2'],
			gradientToColors: [ '#5C33D0'],
			shadeIntensity: 1,
			type: 'horizontal',
			opacityFrom: 1,
			opacityTo: 1,
...
var chart = new ApexCharts(document.querySelector("#admin-dashboard-chart1"), options);
chart.render();
// admin-dashboard-chart1

// admin-dashboard-chart5
var options22 = {
	series: [{
		name: 'series1',
...
var chart = new ApexCharts(document.querySelector("#admin-dashboard-chart5"), options22);
chart.render();
// admin-dashboard-chart5

// admin-dashboard-chart6
var options23 = {
	series: [{
		name: 'series1',
		data: [31, 40, 28, 51, 42, 109, 100]
...
var chart = new ApexCharts(document.querySelector("#admin-dashboard-chart6"), options23);
chart.render();
// admin-dashboard-chart6
...
var chart = new ApexCharts(document.querySelector("#admin-dashboard-chart2"), options4);
chart.render();
// admin-dashboard-chart2
...
var chart = new ApexCharts(document.querySelector("#admin-dashboard-chart3"), options81);
chart.render();
// admin-dashboard-chart3

// admin-dashboard-chart4
var options82 = {
	series: [44, 55, 41, 17, 15],
	chart: {
		type: 'donut',
...
var chart = new ApexCharts(document.querySelector("#admin-dashboard-chart4"), options82);
chart.render();
// admin-dashboard-chart4
