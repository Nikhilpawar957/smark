                                ...
                                <section class="pb-5">
                                    <form id="campaignStepOne" action="{{ url('api/campaigns') }}" method="post"
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="custom-control custom-checkbox mb-5 mr-3">
                                                            ...
                                                            <label class="custom-control-label"
                                                                for="Barter-1">Barter</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox mb-5 mr-3">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="FixedPay-1">
                                                            <label class="custom-control-label" for="FixedPay-1">Fixed
                                                                Pay</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox mb-5 mr-3">
                                                            <input type="checkbox" class="custom-control-input"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>Media Approval <img class="info-badge"
                                                            src="{{ asset('assets/src/img/info.svg') }}"
                                                            data-toggle="tooltip" data-placement="top"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="mb-3">Campaign brand tags to be entered in
                                                        caption</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="mb-3">Campaign hashtags to be entered in
                                                        caption</label>
