            ...
            <div class="min-height-200px">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="title">
                            <h5 class="mb-4 fw-regular">Add New Branding Campaign</h5>
                        </div>
                    </div>
                </div>
                            ...
                            <form class="tab-wizard wizard-circle wizard">
                                ...
                                <section class="pb-5">
                                    ...
                                    <div class="row">
                                                ...
                                                <ul class="platforms">
                                                    <li>
                                                        ...
                                                        <label for="myCheckbox1"><img
                                                                src="{{ asset('assets/src/img/platform/facebook.svg') }}" /></label>
                                                    </li>
                                                    <li>
                                                        <input type="checkbox" id="myCheckbox2" />
                                                        <label for="myCheckbox2"><img
                                                                src="{{ asset('assets/src/img/platform/youtube.svg') }}" /></label>
                                                    </li>
                                                    <li>
                                                        <input type="checkbox" id="myCheckbox3" />
                                                        <label for="myCheckbox3"><img
                                                                src="{{ asset('assets/src/img/platform/twitter.svg') }}" /></label>
                                                    </li>
                                                    <li>
                                                        <input type="checkbox" id="myCheckbox4" />
                                                        <label for="myCheckbox4"><img
                                                                src="{{ asset('assets/src/img/platform/instagram.svg') }}" /></label>
                                                    </li>
                                                    <li>
                                                        <input type="checkbox" id="myCheckbox5" />
                                                        <label for="myCheckbox5"><img
                                                                src="{{ asset('assets/src/img/platform/telegram.svg') }}" /></label>
                                                    </li>
                                                    <li>
                                                        <input type="checkbox" id="myCheckbox6" />
                                                        <label for="myCheckbox6"><img
                                                                src="{{ asset('assets/src/img/platform/quora.svg') }}" /></label>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label>Is Platform Mandatory ? <img class="info-badge"
                                                        src="{{ asset('assets/src/img/info.svg') }}" data-toggle="tooltip" data-placement="top"
                                                        title="Select your preferred Campaign Payout Option: CPA (Cost Per Action), CPL (Cost Per Lead), or CPT (Cost Per Thousand Impressions)."></img></label>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label>Media Approval <img class="info-badge" src="{{ asset('assets/src/img/info.svg') }}"
                                                        data-toggle="tooltip" data-placement="top"
                                                        title="When checked 'Yes', the company gains the authority to approve or decline media uploads by influencers. Admin has this privilege by default."></img></label>
                                                <div class="d-flex mt-3">
                                                    <div class="custom-control custom-radio mr-3">
                                                        <input type="radio" id="customRadio1" name="customRadio"
                                                            class="custom-control-input" selected />
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label>Enable ASCI Mandatory? <img class="info-badge"
                                                        src="{{ asset('assets/src/img/info.svg') }}" data-toggle="tooltip" data-placement="top"
                                                        title="ASCI Mandatory: When enabled, influencers must provide Government Regulatory body name, Registration code, and certificate upload."></img></label>
                                                <div class="d-flex mt-3">
                                                    <div class="custom-control custom-radio mr-3">
                                                        <input type="radio" id="customRadio1" name="customRadio"
                                                            class="custom-control-input" selected />
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    placeholder="Youtube dedicated video" />
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control"
                                                    placeholder="Send notification on" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="tab campaign-brief">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane fade show active" id="brief"
                                                        role="tabpanel">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-9 pr-0">
                                                    <div class="form-group">
                                                        <label>Maximum Payout * (For Company)</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="tab campaign-brief">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane fade show active" id="brief1"
                                                        role="tabpanel">
                                                        <div class="pd-20 content">
                                                            “Artificial intelligence is that activity devoted to making
                                                            machines intelligent, and intelligence is that quality that
                                                ...
                                                <div class="upload__box">
                                                    <div class="upload__btn-box">
                                                        <label class="upload__btn">
                                                            ...
                                                            <input type="file" name="userfiles[]" data-max_length="20"
                                            ...
                                            <div class="col-md-11 pr-0">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control br-r0"
                                                        value="https://app.smarkerz.com/influencer/register" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="warning-box">
                                                    ...
                                                    <p><b>Default - Visible to all Influencers:</b> Visible to all, so any
                                                        ...
                                                        hidden other influencers can activate the campaign <br> <b>Visible
                                                            to all with restriction :</b> Campaign will be visible to all
                                                        but only added influencers can activate the campaign</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><img src="{{ asset('assets/src/img/table-user.svg') }}"
                                                                    class="border-radius-100 mr-2" width="30"
                                                                    height="30" alt="" /> John Wick</td>
                                                            <td>342</td>
                                                            <td>
                                                                <img src="{{ asset('assets/src/img/add-campaign-icons/instagram.svg') }}"
                                                                    class="mr-2" width="25" height="25"
                                                                    alt="" />
                                                                <img src="{{ asset('assets/src/img/add-campaign-icons/facebook.svg') }}"
                                                                    class="mr-2" width="25" height="25"
                                                                    alt="" />
                                                                <img src="{{ asset('assets/src/img/add-campaign-icons/youtube.svg') }}"
                                                                    class="mr-2" width="25" height="25"
                                                                    alt="" />
                                                            </td>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input class="form-control date-picker"
                                                                placeholder="Effective from" type="text" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
