...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/influencer/styles/style.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/influencer/styles/custom.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/influencer/styles/responsive.css') }}" />
...
<body>
    ...
    @include('influencer.layout.inc.sidebar')

    @yield('content')

    @include('influencer.layout.inc.footer')
