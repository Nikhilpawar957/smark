...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/brand/styles/style.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/brand/styles/custom.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/brand/styles/responsive.css') }}" />
...
<body>
    ...
    @include('brand.layout.inc.sidebar')

    @yield('content')

    @include('brand.layout.inc.footer')
